...
function getTextAreaIdentifier(textArea) {
  ...
  let img2img_n = img2img.querySelector(
...
function navigateInList(textArea, event) {
  ...
  // Update highlighting
  if (selectedTag !== null) updateSelectionStyle(textArea, selectedTag);
...
onUiUpdate(function() {
  ...
  // Already added?
  if (
    gradioApp().querySelector(".autocompleteResults.p") !== null &&
  ...
  textAreas.forEach(area => {
    ...
    if (
      textAreaId.includes("p") ||
      (textAreaId.includes("n") && acConfig.activeIn.negativePrompts)
    ) {
